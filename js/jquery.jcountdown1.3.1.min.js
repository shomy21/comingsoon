...
*/
(function(l){l.fn.countdown=function(q){var x={date:new Date,updateTime:1E3,htmlTemplate:'<div class="day-container">%{d}<span class="cd-time">days</span></div><div  class="hour-container">%{h}<span class="cd-time">hours</span></div><div  class="minute-container"> %{m} <span class="cd-time">mins</span></div><div class="second-container"> %{s} <span class="cd-time">sec</span></div>',minus:false,onChange:null,onComplete:null,onResume:null,onPause:null,leadingZero:false,offset:null,hoursOnly:false,direction:"down"},y=[].slice,j=Math.floor,s=/(%\{d\}|%\{h\}|%\{m\}|%\{s\})/g,m=/%\{d\}/,n=/%\{h\}/,o=/%\{m\}/,p=/%\{s\}/,t=function(d){d=d||
